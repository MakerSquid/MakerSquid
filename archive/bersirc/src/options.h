...
#define B_OPTS_PAGE_CREATE_PARMS char *title, CWidget *parent, int px, int py, int pw, int ph, XMLItem *identity
#define B_OPTIONS_PAGE_CREATE(n) CWidget *n( B_OPTS_PAGE_CREATE_PARMS )
